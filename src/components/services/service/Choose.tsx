...
const Choose = () => {
   ...
   return (
      <>
         <section className="section-bg fix">
            <div className="choose-partner-section pt-100 pb-100">
               <div className="container">
                  <div className="row g-4 justify-content-between">
                     <div className="col-lg-6">
                        <div className="section-header mb-40">
                           ...
                           <h2 className="theme-clr4 fw-800 fw-bold wow fadeInUp" data-wow-delay=".3s">
                              ...
                              <span className="fw-300">Korea-India <br /> Business Success</span>
                           </h2>
                        </div>
                        <div className="nano-project-image position-relative w-100">
                           <img src="/assets/img/about/Choose one - 4.png" alt="img" className="rounded-3 w-100" />
                     ...
                     <div className="col-lg-6">
                        <div className="work-wrapper choose-partner-color d-flex flex-column">
                           {work_data.map((item) => (
                              <div key={item.id} className={`work-list-item rounded-3 bg-white d-flex gap-xl-4 gap-3 wow fadeInUp ${item.class}`}
                                 data-wow-delay=".2s">
